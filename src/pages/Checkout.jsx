          ...
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-col gap-2">
                ...
                <select className="h-[52px] rounded-[10px] border border-[#D9D9D9] px-4 outline-none">
                  <option>France</option>
                </select>
              </div>
              <div className="mt-6">
                <CheckoutInput label="Numéro et nom de rue" />
              </div>
              <div className="mt-6 grid gap-6 md:grid-cols-2">
                <CheckoutInput label="Code Postal" />

                <CheckoutInput label="Ville" />
              </div>
              <div className="mt-6">
